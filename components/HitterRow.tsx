...
export function HitterRow({ hitter, isOpen, onToggle }: HitterRowProps) {
  const team = teamData[hitter.team] || {};
  const accent = team.primary || "#3b82f6";
  const tier = getScoreTier(hitter.score.final_score);
    ...
    <div className="rounded-xl border border-gray-800 bg-gray-900 overflow-hidden">
      ...
      >
        ...
        <div className="text-right">
          <div className="text-white font-semibold">{hitter.streak}-game</div>
